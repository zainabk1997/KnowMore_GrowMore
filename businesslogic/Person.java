...
public class Person {
   ...
   public void setCommunity(Community community) {
    ...
    public String toString() {
        return "Person{" + "personFirstName=" + personFirstName + ", personLastName=" + personLastName + ", personGender=" + personGender + ", personId=" + personId + ", dateOfBirth=" + dateOfBirth + ", personPhoneNumber=" + personPhoneNumber + ", personEmailAddress=" + personEmailAddress + ", community=" + community + ", userPassword=" + userPassword + ", userRole=" + userRole + '}';
    }
